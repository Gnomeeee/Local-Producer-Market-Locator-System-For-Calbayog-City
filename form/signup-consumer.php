...
<head>
  ...
  <link rel="stylesheet" href="../Assets/styles/signup-consumer.css">
  ...
  <title>LPMLS - Signup - Consumer</title>
</head>
<body>
  <div class="container">
    ...
    <div class="signup-form">
      <div class="header">
          <div class="header-svg">
              <img class="user-svg" src="../Assets/svg/user-svgrepo-com.svg" alt="User"> 
          </div>
          <div class="title-text">
            <h2>Create Your Account</h2>
            <p>Signing up as: <span>Consumer</span></p>
          </div>
        </div>
        <?php
        ...
        <div class="signup">
          <form action="../Includes/functions.php" method="post">
            ...
            <button class="btn" type="submit" name="consumer_signup" id="signupBtn">
